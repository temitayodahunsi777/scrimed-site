...
- Local `npm` unavailability is bypassed through the contract-backed `node scripts/scrimed-local-quality-runner.mjs` path for cleanup, integrity, hygiene, nonsecret tests, typecheck, lint, and build.
