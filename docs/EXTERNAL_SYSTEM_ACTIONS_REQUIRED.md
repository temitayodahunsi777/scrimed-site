...
- Vercel: the connected project was `READY` on 2026-08-01. Production remains at commit `5e77beea57f458883f7544421b2014fd4e28ac67`; the latest ready preview belongs to a different branch. The current dirty candidate is intentionally not deployed. Bind deployment authorization to the final reviewed commit and fingerprints before using the normal workflow, then collect exact-release post-deployment smoke evidence.
