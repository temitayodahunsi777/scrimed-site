...
Protected workspaces now expose Release Authority Attestations at `/api/pilot-workspaces/{workspaceSlug}/release-authority-attestations` and audited packet downloads at `/api/pilot-workspaces/{workspaceSlug}/release-authority-attestations/packet`. This records no-PHI metadata references to externally retained release authority across counsel, customer permission, executive sponsorship, privacy/security, finance, clinical governance, and marketing claims. Release remains disabled. This must not be used as legal approval, public release approval, external distribution approval, audited financial reporting, securities offering material, customer permission, advertising substantiation, clinical validation, reimbursement assurance, compliance certification, production authorization, or live clinical execution authorization.

Protected workspaces now expose Evidence Room Recipient Attestations at `/api/pilot-workspaces/{workspaceSlug}/evidence-room-recipient-attestations` and audited packet downloads at `/api/pilot-workspaces/{workspaceSlug}/evidence-room-recipient-attestations/packet`. This records no-PHI metadata references to intended recipient segments, evidence-room references, packet references, access windows, and revocation posture after release authority metadata is complete. Export remains disabled. This must not be used as legal approval, public release approval, external distribution approval, audited financial reporting, securities offering material, exact recipient-list storage, recipient email storage, customer permission, advertising substantiation, clinical validation, reimbursement assurance, compliance certification, production authorization, or live clinical execution authorization.
