...
Use this packet only if fresh verification detects drift. Historical 2026-07-27 evidence records
the intended publication, but it cannot close the current candidate's direct-live gate.
...
On 2026-08-01, the exact FaithCore replacement body and CTA were entered and saved in the
authenticated Wix Editor. The Vitals draft was also inspected and contains the approved
synthetic-only boundary. No publication was performed. Publication remains a founder interim
decision, and the published-site gate remains open until fresh live and mobile evidence passes.
