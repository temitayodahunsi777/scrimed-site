# Wix FaithCore Final Action

**Page:** FaithCore (`/faithcore`)
**Owner:** Founder/Wix site owner
...
- The desktop draft was inspected and contains the required clinically neutral copy and CTA.
...
activation, mandatory spiritual governance, or clinical-authority wording. Metadata must remain
FaithCore-specific and optional.

After exact-candidate founder interim acceptance, publish through the normal owner flow. Check
desktop and true 390px mobile layouts, CTA target, page title/description, JSON-LD, and visible
copy. Then run `npm run verify:wix-production` and `npm run verify:live-mobile`. Republish or
refresh Wix SEO output if stale cache remains. Do not mark complete until fresh production
