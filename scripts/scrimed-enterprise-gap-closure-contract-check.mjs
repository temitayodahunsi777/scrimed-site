...
const required = {
  ...
  "app/api/product/console/route.ts": ["getProductConsoleApiSummary"],
  ...
  "docs/release/ENTERPRISE_GAP_CLOSURE_COMMIT_MANIFEST.md": ["94 attributable", "does not include a Supabase setting change"],
