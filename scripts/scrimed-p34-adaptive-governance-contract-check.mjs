...
const [
  ...
  readFile("app/lib/scrimed-p34/workflowContinuity.ts", "utf8"),
...
const assertions = [
  ...
  [types.includes("WorkflowContract"), "versioned workflow contract"],
  [types.includes("ActionMaturityState"), "action maturity contract"],
  [types.includes("PilotExpansionEvidence"), "trust expansion contract"],
  [types.includes("CareTeamRelationshipPeriod"), "continuity relationship contract"],
  [types.includes("PublicSectorReadinessEvidenceProfile"), "public-sector evidence contract"],
  [types.includes("ChallengerModelProfile"), "challenger model contract"],
  ...
  [workflowContinuity.includes("validateWorkflowContract"), "workflow contract validator"],
  [workflowContinuity.includes("selectWorkflowModelFitRoute"), "model-fit router"],
  [workflowContinuity.includes("transitionActionMaturity"), "action maturity policy"],
  [workflowContinuity.includes("evaluateTrustExpansion"), "trust expansion gate"],
  [workflowContinuity.includes("evaluateContinuityOfCare"), "continuity assessment"],
  [workflowContinuity.includes("evaluatePublicSectorReadiness"), "public-sector evidence policy"],
  [workflowContinuity.includes("evaluateIsolatedChallenger"), "isolated challenger harness"],
  [workflowContinuity.includes("redactWorkflowTelemetry"), "telemetry redaction"],
  ...
  [page.includes("Workflow + Action"), "workflow action UI"],
  [page.includes("Continuity + Expansion"), "continuity expansion UI"],
  ...
  [route.includes('endpoint === "p34/workflows"'), "p.34 workflow API"],
  [route.includes('endpoint === "p34/model-fit"'), "p.34 model-fit API"],
  [route.includes('endpoint === "p34/actions"'), "p.34 action API"],
  [route.includes('endpoint === "p34/continuity"'), "p.34 continuity API"],
  [route.includes('endpoint === "p34/public-sector"'), "p.34 public-sector API"],
  [route.includes('endpoint === "p34/challengers"'), "p.34 challenger API"],
  [route.includes('endpoint === "p34/roi"'), "p.34 ROI API"],
  ...
  [packageJson.includes('"test:scrimed-p34-workflow-continuity"'), "workflow continuity policy script"],
  ...
  [mainDoc.includes("Workflow, Model Fit, And Action Maturity"), "workflow and action documentation"],
  [mainDoc.includes("Trust Expansion And Continuity"), "trust expansion documentation"],
  [mainDoc.includes("Public Sector And Challengers"), "challenger and public-sector documentation"],
  [threat.includes("Burned-in annotation"), "threat update"],
  [threat.includes("Public leaderboard"), "leaderboard threat control"],
