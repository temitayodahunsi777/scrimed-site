...
create index if not exists execution_attempts_tenant_id_idx
  on private.execution_attempts(tenant_id);
create index if not exists execution_attempts_created_by_idx
  on private.execution_attempts(created_by);
create index if not exists execution_attempt_events_tenant_id_idx
  on private.execution_attempt_events(tenant_id);
create index if not exists execution_attempt_events_actor_user_id_idx
  on private.execution_attempt_events(actor_user_id);
create index if not exists execution_attempt_review_dispositions_tenant_id_idx
  on private.execution_attempt_review_dispositions(tenant_id);
create index if not exists execution_attempt_review_dispositions_actor_user_id_idx
  on private.execution_attempt_review_dispositions(actor_user_id);
