...
import { buildPilotHandoffCommandBrief } from "../../../lib/pilotHandoffCommand";

export async function GET() {
  return new NextResponse(buildPilotHandoffCommandBrief(), {
    headers: {
      "Content-Disposition": 'attachment; filename="scrimed-pilot-handoff-command-brief.md"',
      "Content-Type": "text/markdown; charset=utf-8",
      "X-SCRIMED-Automation-Authority": "recommendation-only",
      ...
      "X-SCRIMED-External-Send-Authority": "human-review-required",
