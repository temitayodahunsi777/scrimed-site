...
import { buildPilotActivationPlannerBrief } from "../../../lib/pilotActivationPlanner";

export async function GET() {
  return new NextResponse(buildPilotActivationPlannerBrief(), {
    headers: {
      "Content-Disposition": 'attachment; filename="scrimed-pilot-activation-planner-brief.md"',
