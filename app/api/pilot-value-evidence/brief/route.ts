...
import { buildPilotValueEvidenceBrief } from "../../../lib/pilotValueEvidence";

export async function GET() {
  return new NextResponse(buildPilotValueEvidenceBrief(), {
    headers: {
      "Content-Disposition": 'attachment; filename="scrimed-pilot-value-evidence-brief.md"',
