...
export const readinessChecks: ReadinessCheck[] = [
  ...
  { name: "execution_attempt_readiness", status: "watch", detail: "/workflows/execution-attempts and /api/workflows/execution-attempts define the idempotency, durable attempt state, replay, concurrency, failure quarantine, runtime-safety handoff, privacy, and regional attempt-compliance decisions required before governed execution can create attempts." },
  { name: "runtime_safety_readiness", status: "watch", detail: "/workflows/runtime-safety and /api/workflows/runtime-safety define the throttling, abuse-signal, connector-containment, emergency shutdown, escalation, override, restoration, and synthetic safety-drill decisions required before governed execution can accept requests." },
...
export const hubEvents: HubEvent[] = [
  ...
  {
    id: "scrimed-runtime-safety-readiness",
    type: "operations",
    summary: "Added a runtime safety readiness register for throttling, abuse signals, connector containment, emergency shutdown, escalation, overrides, restoration, and synthetic safety drills.",
    date: "2026-06-01"
  },
  {
