...
export const omegaProductSeeds: OmegaProductSeed[] = [
  ...
  },
  {
    ...
    coreCapabilities: ["synthetic vitals explanation drafts", "RPM readiness analysis", "patient engagement workflow analysis"],
    aiAgents: ["patient education agent", "clinical safety verifier", "engagement reviewer"],
    workflows: ["reviewable synthetic trend display", "follow-up workflow draft", "human escalation planning"],
